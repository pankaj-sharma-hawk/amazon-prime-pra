    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'videoref':
          ...
          break;
        case 'videorefint':
          result.videorefint.replace(serializers.deserialize(value,
                  specifiedType:
                      const FullType(BuiltList, const [const FullType(int)]))!
              as BuiltList<Object?>);
          break;
...
class UsersRecordBuilder implements Builder<UsersRecord, UsersRecordBuilder> {
  ...
  ListBuilder<int>? _videorefint;
  ListBuilder<int> get videorefint =>
      _$this._videorefint ??= new ListBuilder<int>();
