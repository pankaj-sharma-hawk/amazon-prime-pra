...
class AppStateNotifier extends ChangeNotifier {
  AmazonPrimeFirebaseUser? initialUser;
  AmazonPrimeFirebaseUser? user;
  ...
  void update(AmazonPrimeFirebaseUser newUser) {
    initialUser ??= newUser;
    user = newUser;
        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              ...
              path: 'infoPage',
              asyncParams: {
                'infodocument': getDoc('videodata', VideodataRecord.serializer),
              },
              builder: (context, params) => InfoPageWidget(
                infodocument:
                    params.getParam('infodocument', ParamType.Document),
                epno: params.getParam('epno', ParamType.int),
                epmin: params.getParam('epmin', ParamType.int),
              ),
            ),
            FFRoute(
              name: 'WatchPage',
